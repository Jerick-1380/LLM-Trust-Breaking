"""
Compare lying rates between original and assume_honest experiments for 4 agents.
"""
...
def calculate_differences():
    ...
    print("="*100)
    print("COMPARING LYING RATES: Original vs Assume Honest (4 AGENTS)")
    print("="*100)
    print()
    ...
    # Overall summary
    print(f"\n\n{'='*100}")
    print("OVERALL SUMMARY (4 AGENTS)")
    print(f"{'='*100}")
...
def create_latex_table():
    ...
    print("\n" + "="*100)
    print("LATEX TABLE (for paper) - 4 AGENTS")
    print("="*100)
    print()
    ...
    latex = "\\begin{table}[h]\n"
    latex += "\\centering\n"
    latex += "\\caption{Lying Rate Comparison: Original vs Assume Honest (4 agents)}\n"
    ...
    latex += "\\hline\n"
    latex += "\\end{tabular}\n"
    latex += "\\label{tab:assume_honest_comparison_4agents}\n"
    latex += "\\end{table}\n"
